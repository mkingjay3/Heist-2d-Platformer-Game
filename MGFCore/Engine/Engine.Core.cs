...
static partial class Engine
{
    ...
    public static void RunGame(GameBase game, string[] args)
    {
    ...
    public static void Start()
    {
        ...
        while (true)
        {
            ...
            if (File.Exists(Path.Combine(sourceBase, "MinimalistGameFramework.sln")) &&
                Directory.Exists(Path.Combine(sourceBase, @"MGFCore\Libraries")))
            {
                sourceBase = Path.Combine(sourceBase, @"MGFCore\Libraries");
                MirrorDirectory(sourceBase, Path.Combine(targetBase, ""), false);
                break;
            }
