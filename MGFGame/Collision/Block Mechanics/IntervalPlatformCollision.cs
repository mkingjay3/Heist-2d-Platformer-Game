...
{
    public class IntervalPlatformCollision : ICollidable
    {
        private Tile tile;
        public static float globalTimer = 0f;
        private float interval = 2f;

        public IntervalPlatformCollision(Tile tile)
        {
            this.tile = tile;
        }
        ...
        {
            bool isActive = (globalTimer % (interval * 2)) < interval;
        ...
        {
            return (globalTimer % (interval * 2)) < interval;
        }
