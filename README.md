# Museum Heist (platformer game)

Team: Varun Hari, Arda Keskinpala, Sriram Kalle-Marasanapalle, Arlene Shergill

A 2D platformer built for a game design course, Fall 2025–Winter 2026. You play a thief working through the floors of a museum, avoiding lasers and guards to steal collectibles, before your employer betrays you in a final boss fight.

## Project background
Built across five checkpoints, run as playtest-driven iterations rather than fixed sprints:

| Checkpoint | Milestone | Approx. date |
|---|---|---|
| Checkpoint 1 | Project plan, core mechanics assigned | Oct 31, 2025 |
| Checkpoint 1 playtest | First playable build, observation notes | Nov 11, 2025 |
| — | State diagram, project plan v2 | Nov 13, 2025 |
| Checkpoint 2 | Playtest feedback round | Nov 23, 2025 |
| Checkpoint 3 | Playtest | Dec 4, 2025 |
| Checkpoint 4 | Playtest | Dec 19, 2025 |
| Checkpoint 5 | Navigation and mechanics largely complete | Jan 14, 2026 |

Dates come from the checkpoint documents in `/Docs`. This repo was migrated here from a school GitHub Classroom account in August 2026 ahead of losing access to that account.

## Engine credit
`MGFCore` is not our code — it's the Minimalist Game Framework starter engine (© 2020 Zach Barth and Keith Holman, MIT license, see `MGFCore/LICENSE.md`), a thin C#/SDL2 layer provided as the course's starting point. Our work is in `MGFGame` — the levels, screens, scoring, enemy behavior, and game state built on top of it.
...
class Game
{
    ...
    public Game()
    {
        Title = "Minimalist Game Framework";
